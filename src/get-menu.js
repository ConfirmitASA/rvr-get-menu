 ...
 * @returns {Array.<{label:String, pageID:String, submenu:Array}>} Returns an (multilevel?) array from menu
 * */
class GetMenu{
   ...
   * @param {Array} obj - menu array to which a new level is attached
   * */
